...
const Meteo = ({ city, zip }) => {
    ...
    return (
        <div className="meteo">
            ...
            <h3 className='meteo_temp'><span className={temp > 15 ? 'meteo_temp meteo_temp--hot' : 'meteo_temp meteo_temp--cold'} > {temp} </span>°c</h3>
            {sky === 'Clouds' ? <i className="fas fa-cloud"></i> : <i className="fas fa-sun"></i>}
